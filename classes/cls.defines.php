<?php
	...
	$com_theme   = (isset($_REQUEST['theme'])) ? clean_request($_REQUEST['theme']) : '';
	...
	if(isset($_REQUEST['ptab'])) {$ptab=clean_request($_REQUEST['ptab']);} else { 
		$ptab= (!empty($_SESSION['sess_uawb_front']['member']) and $_SESSION['sess_uawb_front']['member']['u_organization_id']>0) ? 'dashboard' : 'dashboard';
	}
